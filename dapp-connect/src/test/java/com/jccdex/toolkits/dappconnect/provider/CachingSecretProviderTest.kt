...
class CachingSecretProviderTest {
    ...
    @Test
    fun `concurrent calls for same address delegate once`() =
        runTest {
    ...
    @Test
    fun `concurrent secret calls for same address delegate once`() =
        runTest {
            val spy = SpySecretProvider()
            val cache = CachingSecretProvider(spy)
    ...
    @Test
    fun `cache returns value from delegate`() =
        runTest {
            val spy = SpySecretProvider()
            val cache = CachingSecretProvider(spy)
    ...
    @Test
    fun `second call within bridge window reuses cache`() =
        runTest {
            val spy = SpySecretProvider()
            val cache = CachingSecretProvider(spy)
    ...
    @Test
    fun `different address calls delegate separately`() =
        runTest {
            val spy = SpySecretProvider()
            val cache = CachingSecretProvider(spy)
    ...
    @Test
    fun `different origins do not share cached private key`() =
        runTest {
            val spy = SpySecretProvider()
            val cache = CachingSecretProvider(spy)
    ...
    @Test
    fun `different origins do not share cached secret`() =
        runTest {
            val spy = SpySecretProvider()
            val cache = CachingSecretProvider(spy)
    ...
    @Test
    fun `same origin reuses cache across calls`() =
        runTest {
            val spy = SpySecretProvider()
            val cache = CachingSecretProvider(spy)
    ...
    @Test
    fun `clearCache forces new delegate calls`() =
        runTest {
            val spy = SpySecretProvider()
            val cache = CachingSecretProvider(spy)
